...
#Region "Fetch Employee Profile for Exporting"
    Private Function FetchEmployeeName(employeeNumber As String) As (String, String)
...
#Region "Export to PDF"
    ...
    Public Sub ExportToPDF(connection As OleDbConnection, filePath As String, employeeNumber As String)
        ...
        Dim pdfWriter As PdfWriter = PdfWriter.GetInstance(doc, New FileStream(filePath, FileMode.Create))
        doc.Open()
        ...
        Dim firstName As String = employeeName.Item1
        Dim lastName As String = employeeName.Item2
        Dim fileName As String = $"{employeeNumber} {firstName.Trim} {lastName}.pdf"
        filePath = Path.Combine(Path.GetDirectoryName(filePath), fileName)
        ...
        Dim title As New Paragraph($"Skills Profile for {firstName.Trim} {lastName}", gothamboldFont)
        ...
        ExportTableToPDF(connection, doc, "Employee_Profile", employeeNumber, "Employee Profile")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Job_History", employeeNumber, "Job History")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Task_Profile", employeeNumber, "Task Profile")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Software_Tools", employeeNumber, "Software/Tools")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Skills_Interview", employeeNumber, "Skills Interview")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Performance_Evaluation", employeeNumber, "Performance Evaluation")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Skills_Triage", employeeNumber, "Skills Triage")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Training_History", employeeNumber, "Training History")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Certifications_and_Licenses", employeeNumber, "Certification and Licenses")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Training_Plan", employeeNumber, "Training Plan")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Training_Programs", employeeNumber, "Training Programs")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Webinars_Attended", employeeNumber, "Webinars Attended")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Client_Feedback", employeeNumber, "Client Feedback")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Self_Assessment", employeeNumber, "Self Assessment")
        doc.Add(New Paragraph(" "))

        ExportTableToPDF(connection, doc, "Competency_Certification", employeeNumber, "Competency Certification")
        doc.Add(New Paragraph(" "))

        ' Repeat for other sections: Task Profile, Software Tools, etc.

        doc.Close()
        pdfWriter.Close()
    End Sub

    Public Sub ExportTableToPDF(connection As OleDbConnection, pdfDoc As Document, tableName As String, employeeNumber As String, sectionTitle As String)
        connection.Open()
        ...
        Using command As New OleDbCommand(query, connection)
            ...
            Dim title As New Paragraph(sectionTitle, gothambookFont)
