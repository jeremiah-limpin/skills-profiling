...
#Region "EmployeeListF Load and Close"
    Private Sub EmployeeListF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        rdbtnAllEmployees.Checked = True 'Checks rdbtnAllEmployees to Show All Employees on Form Load
...
#Region "Data Grid Formatting"
    ...
    Public Sub DataGridFormatting()
        ...
        ' 778
        EmployeeListDataGrid.Columns("Employee_Number").AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
        EmployeeListDataGrid.Columns("Employee_Last_Name").AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
        EmployeeListDataGrid.Columns("Employee_First_Name").AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
        EmployeeListDataGrid.Columns("Status").AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
        EmployeeListDataGrid.Columns("Last_Update").AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill

        EmployeeListDataGrid.Columns("Employee_Number").MinimumWidth = 140 '200 '212.83
        EmployeeListDataGrid.Columns("Employee_Last_Name").MinimumWidth = 150 '300 '312.83
        EmployeeListDataGrid.Columns("Employee_First_Name").MinimumWidth = 150 '300 '312.83
        EmployeeListDataGrid.Columns("Status").MinimumWidth = 138 '484 '115.83
        EmployeeListDataGrid.Columns("Last_Update").MinimumWidth = 100 '484 '312.83
...
#Region "Search"
    Private Sub txtSearchEmployeeNumber_TextChanged(sender As Object, e As EventArgs) Handles txtSearchEmployeeNumber.TextChanged
        ...
        Else
            ...
            ElseIf employeeRole = 3 Then
                query = "SELECT Employee_Number, Employee_First_Name, Employee_Last_Name, Last_Update, Status FROM Employee_Profile WHERE (Employee_Role < 2) AND (Employee_Number <> @EmployeeID) AND (Employee_Number LIKE @SearchText)"
            ElseIf employeeRole = 2 Then
                query = "SELECT Employee_Number, Employee_First_Name, Employee_Last_Name, Last_Update, Status FROM Employee_Profile WHERE (Employee_Role < 2) AND (Employee_Number <> @EmployeeID) AND (Employee_Number LIKE @SearchText)"
            End If
        End If
...
#Region "User Menu"
    ...
    Private Sub picboxReload_MouseEnter(sender As Object, e As EventArgs) Handles picboxReload.MouseEnter, lblReload.MouseEnter
        picboxReload.BackColor = Color.LightBlue
    End Sub

    Private Sub picboxReload_MouseLeave(sender As Object, e As EventArgs) Handles picboxReload.MouseLeave, lblReload.MouseLeave
        picboxReload.BackColor = Color.Transparent
    End Sub

    Private Sub picboxReload_MouseDown(sender As Object, e As MouseEventArgs) Handles picboxReload.MouseDown, lblReload.MouseDown
        picboxReload.BackColor = Color.SkyBlue
    End Sub

    Private Sub picboxReload_MouseUp(sender As Object, e As MouseEventArgs) Handles picboxReload.MouseUp, lblReload.MouseUp
        picboxReload.BackColor = Color.LightBlue
    End Sub
